...
export function arenaDraftPlayerSnapshot(player, wutConfig = {}) {
  ...
  return {
    ...
    seasonStats: player.seasonStats ? JSON.parse(JSON.stringify(player.seasonStats)) : {},
    editionStats: player.editionStats ? JSON.parse(JSON.stringify(player.editionStats)) : null,
    s1SyntheticRates: player.s1SyntheticRates ? JSON.parse(JSON.stringify(player.s1SyntheticRates)) : null,
    s2: player.s2 ? JSON.parse(JSON.stringify(player.s2)) : null,
    s3: player.s3 ? JSON.parse(JSON.stringify(player.s3)) : null,
    expectedWutFpPerMatch: player.expectedWutFpPerMatch ?? null,
    weightedFpPerGame: player.weightedFpPerGame ?? null,
    rarityGamesPlayed: player.rarityGamesPlayed ?? null,
